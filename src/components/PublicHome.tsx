      ...
      <nav className="border-b border-zinc-200 dark:border-zinc-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            <Link
              href="/register"
              className="px-4 py-2 text-sm bg-zinc-900 dark:bg-zinc-700 hover:bg-zinc-800 dark:hover:bg-zinc-600 text-white rounded-md transition-colors"
            >
              Sign Up
            </Link>
            <button
      ...
      <main className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-20">
        <div className="max-w-3xl text-center">
          <div className="flex justify-center mb-8">
            <img
              src="/yourpost-hero.svg"
              alt="YourPost Hero"
              width={120}
              height={120}
              className={theme === 'light' ? '' : 'invert dark:invert-0'}
            />
          </div>
          ...
          <p className="text-xl text-zinc-600 dark:text-zinc-400 mb-8 max-w-2xl mx-auto">
            ...
            Available as open-source or managed SaaS.
          </p>
          <div className="flex items-center justify-center gap-4">
            <Link
              href="/register"
              className="px-8 py-3 bg-zinc-900 dark:bg-zinc-700 hover:bg-zinc-800 dark:hover:bg-zinc-600 text-white font-medium rounded-lg transition-colors"
            >
              Get Started
            </Link>
            <a
              ...
              className="px-8 py-3 border border-zinc-300 dark:border-zinc-600 text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-800 font-medium rounded-lg transition-colors"
            >
              View on GitHub
            </a>
          </div>
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-3">
            <span className="px-4 py-1.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-full text-sm">
              Open Source
            </span>
            <span className="px-4 py-1.5 bg-zinc-100 dark:bg-zinc-800 text-zinc-700 dark:text-zinc-300 rounded-full text-sm">
              SaaS Available
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-700 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <p className="text-sm text-zinc-500 dark:text-zinc-400">
            © {new Date().getFullYear()} Devstroop. YourPost is open-source under MIT license.
          </p>
        </div>
      </footer>
    </div>
