...
export function WebmailLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-zinc-900 overflow-hidden">
      {/* Top bar */}
      <header className="h-14 flex-shrink-0 flex items-center justify-between px-4 sm:px-6 border-b border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900">
        ...
        <div className="flex items-center gap-2">
          <span className="text-sm text-zinc-400 dark:text-zinc-500 hidden sm:block mr-2 select-none">
            {email}
          </span>
          <button
            onClick={toggleTheme}
