...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900">
      {/* Admin header — visually distinct from the user header */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-zinc-900 dark:bg-zinc-950 border-b border-zinc-700">
            ...
            <div className="flex items-center gap-4">
              <Link href="/admin" className="flex items-center gap-2">
                <span
                  ...
                  dangerouslySetInnerHTML={{ __html: theme === 'light' ? logoFilledSvg : logoFilledSvg }}
                />
                <span className="font-bold text-xl text-white">YourPost</span>
                <span className="ml-1 px-2 py-0.5 text-xs font-semibold bg-purple-600 text-white rounded">
                  Admin
                </span>
              </Link>
            </div>
