...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900">
      <header className="fixed top-0 left-0 right-0 z-50 h-14 flex items-center justify-between px-6 bg-zinc-900 dark:bg-zinc-950 border-b border-zinc-800">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/inbox"
            className="flex items-center gap-1.5 text-sm text-zinc-400 hover:text-white transition-colors px-2 py-1.5"
          >
