...
export default function SystemLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-900">
      <header className="fixed top-0 left-0 right-0 z-50 h-14 flex items-center justify-between px-6 bg-red-950 border-b border-red-900">
        <div className="flex items-center gap-3">
          <Link href="/system" className="flex items-center gap-2.5 text-white">
        ...
        <div className="flex items-center gap-2">
          <Link
            href="/inbox"
            className="flex items-center gap-1.5 text-sm text-red-300 hover:text-white transition-colors px-2 py-1.5"
          >
          ...
          <button
            onClick={toggleTheme}
            className="p-2 rounded-md text-red-300 hover:text-white transition-colors"
